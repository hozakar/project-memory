...
truth, mirrored verbatim into the host instructions file so it survives context compaction. It
is not restated here; this file holds the full procedures those triggers invoke.
