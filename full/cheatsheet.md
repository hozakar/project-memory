...
| ~25 phases accumulated since last era | Prompt maintainer to create era (developers: silent), then create `era-NNN.md`, add entry to `eras/index.yml`, call `index_era` per `mcp-integration.md` |
