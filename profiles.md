...
| 3 | Drift Audit | 7 categories (5,6,8,9,11,13,14). Phase-related categories retired. Cat 7, 12 dropped. | none |
...
How do you want to run project-memory in this project?
  ...
  1) standard — lean ceremony, 2 summaries, 7-category audit, for most projects
