...
- `run_audit(project_memory_dir, profile?)` — execute all 7 audit categories; returns {auto_fixed, pending_fixes, escalations}; accepts `profile` parameter (`standard` | `minimal`)
