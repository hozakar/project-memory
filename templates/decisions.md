...
description: Templates for DECISION records and their indexes. Covers DECISION-*.md, adr/NNNN-*.md, decisions/index.md. See conventions/maintainer.md → Author Attribution.
---
