...
description: Template dispatcher for project-memory. Profile-aware for config/summary templates (which differ across standard/minimal); record templates are shared. Read the relevant sub-file when creating new records.
---

# Templates — Index

This file is a dispatcher. Record templates and attribution schemas are shared at the root.
